...
export default function MainContent({ postsData }) {
  ...
  return (
    <main className="col-span-full flex h-full w-full flex-row flex-wrap justify-around border-t-[1px] pl-10 sm:col-span-2 sm:col-start-2 md:col-span-4 lg:col-span-5">
      <Header />
